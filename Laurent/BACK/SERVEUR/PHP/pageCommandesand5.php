...
<body>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6">
                <img src="/Laurent/FRONT/STATIQUE/HTML/Img/Sandwich/Sand 5.jpeg" class="img-fluid rounded" alt="Photo du produit">
            </div>
            <div class="col-md-6 ">
                <h2>Sandwich 5</h2>
                <p>Prix: 8,30 €</p>
                <form action="/Laurent/FRONT/STATIQUE/HTML/ficheCommande.html" method="post">
                    ...
                    <a href="/Laurent/FRONT/STATIQUE/HTML/pageSandwich.html" class="btn btn-primary">Continuer les
                        achats</a>
                </form>
            </div>
        </div>
