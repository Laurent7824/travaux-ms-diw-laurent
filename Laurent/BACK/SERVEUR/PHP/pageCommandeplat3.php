...
<body>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6">
                <img src="/Laurent/FRONT/STATIQUE/HTML/Img/food/courgettes_farcies.jpg" class="img-fluid rounded w-50" alt="Photo du produit">
            </div>
            <div class="col-md-6 ">
                <p>Courgettes_farcies</p>
                <p>Prix: 8 €</p>
                <form action="/Laurent/FRONT/STATIQUE/HTML/ficheCommande.html" method="post">
                    ...
                    <a href="/Laurent/FRONT/STATIQUE/HTML/carousel.html" class="btn btn-primary">Continuer les
                        achats</a>
                </form>
            </div>
        </div>
