...
<body>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6">
                <img src="/Laurent/FRONT/STATIQUE/HTML/Img/Nom_pizza/pizza 3.jpeg" class="img-fluid rounded w-50" alt="Photo du produit">
            </div>
            <div class="col-md-6 ">
                <h2>Pizza 3</h2>
                <p>Prix: 10 €</p>
                <form action="/Laurent/FRONT/STATIQUE/HTML/ficheCommande.html" method="post">
                    ...
                    <a href="/Laurent/FRONT/STATIQUE/HTML/pagePizza.html" class="btn btn-primary">Continuer les
                        achats</a>
                </form>
            </div>
        </div>
